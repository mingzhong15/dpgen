...
"""Shared helper functions for the DP-GEN generator.

Pure helpers (path/name formatting, index expansion, structure conversion,
atomic-mass lookup, etc.) shared across the train, model_devi, and fp
sub-modules. Kept separate from business logic so each step module can
import a small, stable set of utilities.
"""
